...
int main() { 
    ...
    if(load_network("model.bin", &loaded_loss, &loaded_lr)){
...
# 转换为 UTF-8
utf8_data = utf16_data.decode('utf-16').encode('utf-8')


with open(".\\test_u.cpp", 'wb') as f:
    f.write(utf8_data)
     # 输出 UTF-8 编码的字节数据
